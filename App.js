...
const RowView=({label,value})=>{
  return(
    ...
    >
      <View>
        <Text style={{fontFamily:'Inter-Regular',color:'white',fontSize:10,lineHeight:28,letterSpacing:2,textTransform:'uppercase'}}>
          {label}
        </Text>
      </View>
      <View>
      ...
      <View style={styles.container}>
        ...
        <View style={styles.bottomView}>
          ...
          <View style={{marginTop:50}}>
            ...
            <TouchableOpacity
              onPress={() => { }}
              style={{ flexDirection: 'row', alignItems: 'center', backgroundColor: '#ffffff', width: 115, height: 39, borderRadius: 50 }}
            >
              <Text style={{ fontFamily: 'Inter-Bold', fontSize: 12, lineHeight: 14, letterSpacing: 3.75, textTransform: 'uppercase', width: 57, left: 17,color:'gray' }}>More</Text>
              <Image source={require('./assets/Group 3.png')} style={{ left: 20, width: 32, height: 32 }} />
            </TouchableOpacity>
          </View>
        </View>
